...
description: "Generic transport abstraction that enables easy building of HTTP, WebSocket, and custom protocols"
nav_order: 1
---

# Transport Layer Architecture

This document introduces a protocol-agnostic transport abstraction for building high-performance communication layers across protocols. The same architecture underpins HTTP, WebSocket, and custom transports in Rust, Python, and Node.js.

## Overview

The transport layer provides a unified interface over multiple protocols via a clean abstraction. It enables protocol-specific implementations while maintaining consistency across languages and use cases.
